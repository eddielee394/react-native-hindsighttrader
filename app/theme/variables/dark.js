...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#131c2a',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 60,
  footerDefaultBg: platform === PLATFORM.IOS ? '#131c2a' : '#131c2a',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#007aff' : '#bcc6d9',
  sTabBarActiveTextColor: '#007aff',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#007aff' : '#bcc6d9',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#131c2a',
  tabBarBorderBottomColor: '#d95f1b',
  tabBarIconFontSize: platform === PLATFORM.IOS ? 20 : undefined,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#6d788c' : '#6d788c',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#182129' : '#182129',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#6d788c' : '#bcc6d9',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#007aff' : '#bcc6d9',
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#131c2a' : '#131c2a',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#131c2a',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#131c2a' : '#131c2a',
  segmentActiveBackgroundColor:
    platform === PLATFORM.IOS ? '#007aff' : '#bcc6d9',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#bcc6d9',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#bcc6d9' : '#131c2a',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#bcc6d9',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#030310' : '#030310',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#d95f1b' : '#d95f1b',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#d95f1b' : '#d95f1b',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#d95f1b' : '#d95f1b',
  topTabBarHeight: 80,
  ...
  subtitleColor: platform === PLATFORM.IOS ? '#8e8e93' : '#bcc6d9',
  titleFontColor: platform === PLATFORM.IOS ? '#bcc6d9' : '#bcc6d9',
